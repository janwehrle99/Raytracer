...
TEST(VECTOR, Operator_brackets) {
  Vector3df vector = {0.0, 1.0, 2.0};
  unsigned long long i0 = 0.0;
  unsigned long long i1 = 1.0;
  unsigned long long i2 = 2.0;
  
  EXPECT_NEAR(0.0, vector.operator[](i0), 0.00001);
  EXPECT_NEAR(1.0, vector.operator[](i1), 0.00001);
  EXPECT_NEAR(2.0, vector.operator[](i2), 0.00001);
}
